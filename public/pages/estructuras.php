    ...
    <section class="category-hero">
        <div class="container">
            ...
            <p class="category-desc">
                Inspecciones aéreas, documentación arquitectónica y seguimiento
                de obras. Precisión técnica desde el aire.
            </p>
        </div>
    </section>
...
.close-modal {
    ...
    cursor: pointer;
    z-index: 100000;
    padding: 10px 20px; /* Área de clic amplia */
    line-height: 1;
}
...
/* Hacer que las fotos de la galería parezcan clicables */
